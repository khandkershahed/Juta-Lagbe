                                    ...
                                    <div class="col-12 col-xl-6 pl-0">
                                        <div class="ps-form__group pt-2">
                                            ...
                                            <input class="form-control ps-form__input" type="text" name="thana"
                                                value="{{ old('thana', optional(Auth::user())->thana) }}" autofocus=""
                                                autocomplete="thana" placeholder="আপনার থানা" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-xl-6 pr-0">
                                        <div class="ps-form__group pt-2">
                                            ...
                                            <div class="card-body p-0 rounded-0">
                                                <div class="">
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="mb-0 pl-2 pr-2"><span id="shipping-price">0</span>
                                                            টাকা</p>
                                                    </div>
                                                    <hr class="my-0 bg-white">
                                                    <div
                                                        class="d-flex justify-content-between align-items-center bg-light py-2">
                                                        <p class="mb-0 pl-2 pr-2" style="font-weight: 600;">সর্বমোট
                                                            মূল্য</p>
                                                        <p class="mb-0 pl-2 pr-2"><strong><span id="total-price"
                                                                    style="font-weight: 600;">{{ $product->unit_price }}</span>
                                                                টাকা</strong></p>
                                                    </div>
                                                </div>
                                            </div>
