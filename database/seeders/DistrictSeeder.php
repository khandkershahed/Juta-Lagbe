...
class DistrictSeeder extends Seeder
{
    ...
    public function run()
    {
        $districts = [
            ...
            ['id' => '1', 'division_id' => '1', 'name' => 'Dhaka Metro', 'bn_name' => 'ঢাকা মেট্রো', 'lat' => '23.4682747', 'lon' => '91.1788135', 'url' => 'www.aa.gov.bd'],
            ['id' => '2', 'division_id' => '1', 'name' => 'Dhaka Metro Outside', 'bn_name' => 'ঢাকা সিটির বাইরে', 'lat' => '23.7115253', 'lon' => '90.4111451', 'url' => 'www.dhaka.gov.bd'],

            ['id' => '65', 'division_id' => '6', 'name' => 'Comilla', 'bn_name' => 'কুমিল্লা', 'lat' => '23.4682747', 'lon' => '91.1788135', 'url' => 'www.comilla.gov.bd'],
            ['id' => '47', 'division_id' => '6', 'name' => 'Feni', 'bn_name' => 'ফেনী', 'lat' => '23.023231', 'lon' => '91.3840844', 'url' => 'www.feni.gov.bd'],
            ['id' => '3', 'division_id' => '6', 'name' => 'Brahmanbaria', 'bn_name' => 'ব্রাহ্মণবাড়িয়া', 'lat' => '23.9570904', 'lon' => '91.1119286', 'url' => 'www.brahmanbaria.gov.bd'],
            ['id' => '4', 'division_id' => '6', 'name' => 'Rangamati', 'bn_name' => 'রাঙ্গামাটি', 'lat' => NULL, 'lon' => NULL, 'url' => 'www.rangamati.gov.bd'],
            ['id' => '5', 'division_id' => '6', 'name' => 'Noakhali', 'bn_name' => 'নোয়াখালী', 'lat' => '22.869563', 'lon' => '91.099398', 'url' => 'www.noakhali.gov.bd'],
            ['id' => '6', 'division_id' => '6', 'name' => 'Chandpur', 'bn_name' => 'চাঁদপুর', 'lat' => '23.2332585', 'lon' => '90.6712912', 'url' => 'www.chandpur.gov.bd'],
            ['id' => '7', 'division_id' => '6', 'name' => 'Lakshmipur', 'bn_name' => 'লক্ষ্মীপুর', 'lat' => '22.942477', 'lon' => '90.841184', 'url' => 'www.lakshmipur.gov.bd'],
            ['id' => '8', 'division_id' => '6', 'name' => 'Chattogram', 'bn_name' => 'চট্টগ্রাম', 'lat' => '22.335109', 'lon' => '91.834073', 'url' => 'www.chittagong.gov.bd'],
            ['id' => '9', 'division_id' => '6', 'name' => 'Coxsbazar', 'bn_name' => 'কক্সবাজার', 'lat' => NULL, 'lon' => NULL, 'url' => 'www.coxsbazar.gov.bd'],
            ['id' => '10', 'division_id' => '6', 'name' => 'Khagrachhari', 'bn_name' => 'খাগড়াছড়ি', 'lat' => '23.119285', 'lon' => '91.984663', 'url' => 'www.khagrachhari.gov.bd'],
            ['id' => '11', 'division_id' => '6', 'name' => 'Bandarban', 'bn_name' => 'বান্দরবান', 'lat' => '22.1953275', 'lon' => '92.2183773', 'url' => 'www.bandarban.gov.bd'],

            ['id' => '40', 'division_id' => '1', 'name' => 'Narsingdi', 'bn_name' => 'নরসিংদী', 'lat' => '23.932233', 'lon' => '90.71541', 'url' => 'www.narsingdi.gov.bd'],
            ['id' => '41', 'division_id' => '1', 'name' => 'Gazipur', 'bn_name' => 'গাজীপুর', 'lat' => '24.0022858', 'lon' => '90.4264283', 'url' => 'www.gazipur.gov.bd'],
            ['id' => '42', 'division_id' => '1', 'name' => 'Shariatpur', 'bn_name' => 'শরীয়তপুর', 'lat' => NULL, 'lon' => NULL, 'url' => 'www.shariatpur.gov.bd'],
            ['id' => '43', 'division_id' => '1', 'name' => 'Narayanganj', 'bn_name' => 'নারায়ণগঞ্জ', 'lat' => '23.63366', 'lon' => '90.496482', 'url' => 'www.narayanganj.gov.bd'],
            ['id' => '44', 'division_id' => '1', 'name' => 'Tangail', 'bn_name' => 'টাঙ্গাইল', 'lat' => NULL, 'lon' => NULL, 'url' => 'www.tangail.gov.bd'],
            ['id' => '45', 'division_id' => '1', 'name' => 'Kishoreganj', 'bn_name' => 'কিশোরগঞ্জ', 'lat' => '24.444937', 'lon' => '90.776575', 'url' => 'www.kishoreganj.gov.bd'],
            ['id' => '46', 'division_id' => '1', 'name' => 'Manikganj', 'bn_name' => 'মানিকগঞ্জ', 'lat' => NULL, 'lon' => NULL, 'url' => 'www.manikganj.gov.bd'],
            ['id' => '48', 'division_id' => '1', 'name' => 'Munshiganj', 'bn_name' => 'মুন্সিগঞ্জ', 'lat' => NULL, 'lon' => NULL, 'url' => 'www.munshiganj.gov.bd'],
            ['id' => '49', 'division_id' => '1', 'name' => 'Rajbari', 'bn_name' => 'রাজবাড়ী', 'lat' => '23.7574305', 'lon' => '89.6444665', 'url' => 'www.rajbari.gov.bd'],
            ['id' => '50', 'division_id' => '1', 'name' => 'Madaripur', 'bn_name' => 'মাদারীপুর', 'lat' => '23.164102', 'lon' => '90.1896805', 'url' => 'www.madaripur.gov.bd'],
            ['id' => '51', 'division_id' => '1', 'name' => 'Gopalganj', 'bn_name' => 'গোপালগঞ্জ', 'lat' => '23.0050857', 'lon' => '89.8266059', 'url' => 'www.gopalganj.gov.bd'],
            ['id' => '52', 'division_id' => '1', 'name' => 'Faridpur', 'bn_name' => 'ফরিদপুর', 'lat' => '23.6070822', 'lon' => '89.8429406', 'url' => 'www.faridpur.gov.bd'],
            ...
            ['id' => '72', 'division_id' => '1', 'name' => 'Gazipur Metro', 'bn_name' => 'গাজীপুর মেট্রো', 'lat' => '23.4682747', 'lon' => '91.1788135', 'url' => 'www.aa.gov.bd'],
        ];
