    ...
    public function store(ProductRequest $request)
    {
        ...
        try {
            ...
            $product = Product::create([
                ...
                'color'                     => is_array($request->input('color')) ? $request->input('color') : null,
                'size'                      => is_array($request->input('size')) ? $request->input('size') : null,
    ...
    public function update(ProductRequest $request, $id)
    {
        ...
        try {
            ...
            $product->update([
                ...
                'product_code'              => $request->input('barcode_id'),
                'barcode_id'                => $request->input('barcode_id'),
                'tags'                      => is_array($request->input('tags')) ? $request->input('tags') : $product->tags,
                'color'                     => is_array($request->input('color')) ? $request->input('color') : $product->color,
                'size'                      => is_array($request->input('size')) ? $request->input('size') : $product->size,
                'video_link'                => $request->input('video_link'),
                'short_description'         => $request->input('short_description'),
                'overview'                  => $request->input('overview'),
                'description'               => $request->input('description'),
                ...
                'is_refurbished'            => $is_refurbished,
                'product_type'              => $request->input('product_type'),
                'category_id'               => is_array($request->input('category_id')) ? $request->input('category_id') : $product->category_id,
                'vat'                       => $request->input('vat'),
                'tax'                       => $request->input('tax'),
                'length'                    => $request->input('length'),
                'width'                     => $request->input('width'),
